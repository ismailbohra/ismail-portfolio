...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("access_key", "7177c267-3ef9-44c4-85f0-257e25772e2c");
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:ismailbohra99@gmail.com" target="_blank" className="blue-text-gradient">ismailbohra99@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
