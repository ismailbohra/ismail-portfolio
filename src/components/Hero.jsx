        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm <p className="name text-[#915EFF]">Ismail Bohra</p>
            </h1>
            <h3>
              <span
                ref={textRef}
            ...
            <div className="absolute link1">
              <a href="https://github.com/ismailbohra" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
              ...
              <a href="https://www.instagram.com/smile.bohra" target="_blank">
                <AiOutlineInstagram />
              </a>
            </div>
          </div>
