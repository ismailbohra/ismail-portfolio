      ...
      >
        <div className="Box1 relative w-full h-[180px]">
          <img
            src={image}
            alt="project_image"
            className="image w-full h-full object-fill rounded-2xl"
          />
    ...
    <>
      ...
      <div className="project w-full flex">
        ...
        >
          ...
          <a className="mt-10 text-center text-secondary block cursor-pointer text-[20px] underline" href="https://github.com/ismailbohra">More</a>
      </div>
    </>
  );
};
